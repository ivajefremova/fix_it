      ...
      >
        {countries.map((country, i) => (
          <button
            ...
            style={{
              color: i === active ? '#181831' : 'rgba(24,24,49,0.7)',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            <h3
              ...
              style={{ color: '#181831', fontWeight: 400, fontSize: 'clamp(20px, 2.5vw, 30px)' }}
            >
              Need an explanation for which documents you need to prepare for {c.name}?
            </h3>
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'rgba(24,24,49,0.78)', fontWeight: 400 }}>
            ...
            <div
              ...
              style={{ background: 'rgba(12,77,134,0.07)', color: '#0c4d86', fontWeight: 400 }}
            >
            ...
            <ul className="space-y-3">
              {included.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  ...
                  <span className="text-sm leading-relaxed" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>
                    {item}
                  </span>
                </li>
              ))}
