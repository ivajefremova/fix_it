...
function StatCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl px-5 py-4 flex-1 min-w-[140px]" style={{ background: '#f8f9fb', border: '1px solid #eef0f3' }}>
      <p className="text-xs mb-1" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>{label}</p>
    ...
    <div style={{ position: 'relative', overflow: 'hidden', borderRadius: 20 }}>
      ...
      <div style={{
        ...
        <div className="text-center px-6">
          ...
          <h3 className="text-base text-navy mb-1.5" style={{ fontWeight: 400 }}>{title}</h3>
          <p className="text-sm mb-5 max-w-xs mx-auto leading-relaxed" style={{ color: 'rgba(24,24,49,0.75)', fontWeight: 400 }}>
  ...
  return (
    <div className="relative group rounded-2xl" style={{ background: 'white', border: '1px solid #eef0f3', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
      ...
      <div className="flex items-start justify-between gap-4 mb-3">
        <h3 className="text-base text-navy leading-snug" style={{ fontWeight: 400 }}>{uni.name}</h3>
      ...
      <div className="flex flex-wrap items-center gap-2 mb-3">
        {uni.city && (
          <span className="text-xs" style={{ color: 'rgba(24,24,49,0.72)', fontWeight: 400 }}>{uni.city}</span>
        )}
        {uni.city && uni.type && <span style={{ color: '#e4ebf3' }}>·</span>}
        {uni.type && (
          <span className="text-xs" style={{ color: 'rgba(24,24,49,0.72)', fontWeight: 400 }}>{uni.type}</span>
        )}
        {uni.tuition_range && (
          <>
            <span style={{ color: '#e4ebf3' }}>·</span>
            <span className="text-xs" style={{ color: 'rgba(24,24,49,0.72)', fontWeight: 400 }}>{uni.tuition_range}</span>
          </>
        )}
      </div>

      {uni.ranking_summary && (
        <p className="text-sm mb-3" style={{ color: 'rgba(24,24,49,0.75)', fontWeight: 400 }}>{uni.ranking_summary}</p>
      )}

      {uni.tags && uni.tags.length > 0 && (
        <div className="flex flex-col gap-1.5">
          {uni.tags.filter(t => !['english','bachelor','master','doctorate'].includes(t)).slice(0, 4).map(tag => (
            <span key={tag} className="flex items-center gap-2 text-sm" style={{ color: 'rgba(24,24,49,0.78)', fontWeight: 400 }}>
    ...
    <main style={{ background: '#f0f2f5', minHeight: '100vh' }}>
      ...
      <div className="bg-white">
        <div className="max-w-[90%] mx-auto pt-10 pb-8">
          ...
          {country.tagline && (
            <p className="text-base max-w-xl" style={{ color: 'rgba(24,24,49,0.75)', fontWeight: 400 }}>
              {country.tagline}
            </p>
          )}
        </div>
        ...
        <div className="max-w-[90%] mx-auto flex items-center gap-1 overflow-x-auto">
          {TABS.map(tab => (
            <button
              ...
              style={{
                color: activeTab === tab ? '#181831' : 'rgba(24,24,49,0.7)',
          ...
          <div className="space-y-8">
            ...
            {country.overview_free && (
              <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                ...
                <p className="text-sm sm:text-base leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>
                  {country.overview_free}
                </p>
              </div>
            )}
            ...
            {hasCountryPackage && gated?.why_this_country ? (
              <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                ...
                <h2 className="text-xl sm:text-2xl text-navy mb-4" style={{ fontWeight: 400 }}>
                  Why study in {country.name}?
                </h2>
                <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>
        ...
        {activeTab === 'Lifestyle' && (
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
              ...
              <h2 className="text-xl sm:text-2xl text-navy mb-3" style={{ fontWeight: 400 }}>
                Living in {country.name}
              </h2>
              <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.78)', fontWeight: 400 }}>
              ...
              <>
                ...
                {gated.city_guide && gated.city_guide.length > 0 && (
                  <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                    ...
                    <h2 className="text-xl sm:text-2xl text-navy mb-6" style={{ fontWeight: 400 }}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {gated.city_guide.map((c, i) => (
                        <div key={i} className="rounded-xl p-5" style={{ border: '1px solid #eef0f3', background: '#fafafa' }}>
                          <h3 className="text-base text-navy mb-1.5" style={{ fontWeight: 400 }}>{c.city}</h3>
                          {c.best_for && (
                            <p className="text-xs mb-3" style={{ color: '#51e74c', fontWeight: 400 }}>Best for: {c.best_for}</p>
                          )}
                          {c.description && (
                            <p className="text-sm leading-relaxed" style={{ color: 'rgba(24,24,49,0.78)', fontWeight: 400 }}>{c.description}</p>
                          )}
                        </div>
                      ))}
                    </div>
              ...
              <div className="space-y-6">
                {gatedDocs.visa_process && (
                  <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                    ...
                    <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>{gatedDocs.visa_process}</p>
                  </div>
                )}
                {gatedDocs.moving_guide && (
                  <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                    <SectionLabel text="Moving guide" />
                    <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>{gatedDocs.moving_guide}</p>
                  </div>
                )}
                {gatedDocs.bank_account_guide && (
                  <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                    <SectionLabel text="Bank account setup" />
                    <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>{gatedDocs.bank_account_guide}</p>
                  </div>
                )}
                {gatedDocs.arrival_tips && (
                  <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm">
                    <SectionLabel text="Arrival tips" />
                    <p className="text-sm leading-relaxed max-w-3xl" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>{gatedDocs.arrival_tips}</p>
                  </div>
                )}
              </div>
            ) : !hasDocumentsPackage ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                  {country.tuition_range_public && (
                    <div className="rounded-xl p-5" style={{ border: '1px solid #eef0f3', background: '#fafafa' }}>
                      <p className="text-xs mb-2" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>Public university</p>
                      <p className="text-base text-navy" style={{ fontWeight: 400 }}>{country.tuition_range_public}</p>
                      <p className="text-xs mt-1" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>per year</p>
                    </div>
                  )}
                  {country.tuition_range_private && (
                    <div className="rounded-xl p-5" style={{ border: '1px solid #eef0f3', background: '#fafafa' }}>
                      <p className="text-xs mb-2" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>Private university</p>
                  ...
                  {country.cost_of_living_range && (
                    <div className="rounded-xl p-5" style={{ border: '1px solid #eef0f3', background: '#fafafa' }}>
                      <p className="text-xs mb-2" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>Living costs</p>
                      <p className="text-base text-navy" style={{ fontWeight: 400 }}>{country.cost_of_living_range}</p>
                      <p className="text-xs mt-1" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>per month</p>
                    </div>
                  )}
                </div>
              </div>
                  ...
                  {gatedScholarships.map(s => (
                    <div key={s.id} className="rounded-xl p-5 flex items-start justify-between gap-4" style={{ border: '1px solid #eef0f3', background: '#fafafa' }}>
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-navy mb-1" style={{ fontWeight: 400 }}>{s.name}</p>
                        {s.eligibility && (
                          <p className="text-sm leading-relaxed mb-2" style={{ color: 'rgba(24,24,49,0.75)', fontWeight: 400 }}>{s.eligibility}</p>
                        )}
                        <div className="flex flex-wrap gap-3">
                          {s.amount && (
                            <span className="text-xs" style={{ color: '#0c4d86', fontWeight: 400 }}>{s.amount}</span>
                          )}
                          {s.deadline && (
                            <span className="text-xs" style={{ color: 'rgba(24,24,49,0.72)', fontWeight: 400 }}>Deadline: {s.deadline}</span>
                          )}
                        </div>
                      </div>
                      <Link href={`/services/scholarship/${s.id}`} className="text-xs flex-shrink-0 hover:opacity-70 transition" style={{ color: '#0c4d86', fontWeight: 400 }}>
                        View guide →
                      </Link>
                    </div>
                  ))}
        ...
        {activeTab === 'Universities' && (
          <div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
              <p className="text-xs uppercase tracking-widest mb-4" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>Filter universities</p>
              <div className="flex flex-col gap-4">

                {/* Type */}
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs w-20 flex-shrink-0" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>Type</span>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs w-20 flex-shrink-0" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>English</span>
                  <div className="flex flex-wrap gap-2">
                ...
                {/* Field */}
                <div className="flex flex-wrap items-center gap-2">
                  <span className="text-xs w-20 flex-shrink-0" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>Field</span>
                  <div className="flex flex-wrap gap-2">
                ...
                {cities.length > 2 && (
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-xs w-20 flex-shrink-0" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>City</span>
                    <div className="flex flex-wrap gap-2">
                      {cities.map(c => (
            ...
            {filtered.length === 0 ? (
              <div className="bg-white rounded-2xl p-10 text-center shadow-sm">
                <p className="text-sm" style={{ color: 'rgba(24,24,49,0.7)', fontWeight: 400 }}>No universities match these filters.</p>
              </div>
            ) : (
              <div>
                <p className="text-xs mb-4" style={{ color: 'rgba(24,24,49,0.65)', fontWeight: 400 }}>
