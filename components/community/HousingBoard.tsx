    ...
    <div ref={ref} style={{ position: 'relative', flexShrink: 0 }}>
      <button
        ...
        style={{
          ...
          padding: '6px 10px 6px 12px', borderRadius: 20, fontSize: 12, fontWeight: 400,
          border: '1px solid', cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.15s',
          background: selected.length > 0 ? '#181831' : '#f8f9fb',
          color: selected.length > 0 ? 'white' : 'rgba(24,24,49,0.78)',
        ...
        <div style={{
          ...
          {options.map(opt => (
            <label key={opt.value} style={{
              ...
              cursor: 'pointer', fontSize: 12, fontWeight: 400, color: '#181831',
          ...
          <div style={{
            ...
            <div style={{ padding: '26px 32px 18px', borderBottom: '1px solid #f0f2f5', flexShrink: 0 }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: view === 'list' ? 16 : 0 }}>
                <div>
                  {view === 'form' ? (
                    <button onClick={() => setView('list')} style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, color: 'rgba(24,24,49,0.7)', fontFamily: 'inherit', fontSize: 12, display: 'flex', alignItems: 'center', gap: 4, marginBottom: 10 }}>
                    ...
                    <p style={{ fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.1em', color: '#51e74c', fontWeight: 400, marginBottom: 6 }}>Housing Board</p>
                  )}
                  <h2 style={{ fontSize: 'clamp(20px, 2.2vw, 26px)', color: '#181831', fontWeight: 400, margin: 0, lineHeight: 1.25 }}>
                    {view === 'form' ? 'Post a listing' : 'Looking for accommodation?'}
                  </h2>
                  {view === 'list' && (
                    <p style={{ fontSize: 13, color: 'rgba(24,24,49,0.42)', fontWeight: 400, marginTop: 5 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
                  ...
                  <button onClick={closePanel} style={{ width: 34, height: 34, borderRadius: 10, background: '#f5f6f8', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <svg style={{ width: 14, height: 14, color: 'rgba(24,24,49,0.72)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'center' }}>
                  ...
                  {(['all', 'offering', 'seeking'] as const).map(f => (
                    <button key={f} onClick={() => setFilter(f)} style={{
                      ...
                      color: filter === f ? 'white' : 'rgba(24,24,49,0.75)',
                ...
                loadingListings ? (
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', textAlign: 'center', paddingBottom: 40 }}>
                    <div style={{ width: 52, height: 52, borderRadius: 16, background: '#f5f6f8', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 18 }}>
                      <svg style={{ width: 22, height: 22, color: 'rgba(24,24,49,0.78)' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75" />
                      </svg>
                    </div>
                    <p style={{ fontSize: 15, color: 'rgba(24,24,49,0.7)', fontWeight: 400, marginBottom: 6 }}>No listings yet</p>
                    <p style={{ fontSize: 13, color: 'rgba(24,24,49,0.78)', fontWeight: 400, maxWidth: 300 }}>
                      ...
                      return (
                        <div key={l.id} style={{
                          ...
                          <div style={{ padding: '18px 20px', display: 'flex', flexDirection: 'column', gap: 10, flex: 1 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 7, flexWrap: 'wrap' }}>
                              ...
                              {isOwn && (
                                <button
                                  ...
                                  title="Delete"
                                  style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 4, color: 'rgba(24,24,49,0.78)', marginLeft: l.price ? 0 : 'auto' }}
                            ...
                            <div>
                              <p style={{ fontSize: 14, color: '#181831', fontWeight: 400, marginBottom: 3, lineHeight: 1.4 }}>
                                {l.title}
                              </p>
                              {(l.city || country) && (
                                <p style={{ fontSize: 11, color: 'rgba(24,24,49,0.38)', fontWeight: 400 }}>
                            ...
                            {l.description && (
                              <p style={{ fontSize: 12, color: 'rgba(24,24,49,0.75)', fontWeight: 400, lineHeight: 1.6, flex: 1 }}>
                                {l.description}
                              </p>
                            )}
                            ...
                            {l.contact_info && (
                              <div style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '7px 11px', borderRadius: 10, background: 'rgba(12,77,134,0.05)', border: '1px solid rgba(12,77,134,0.08)', marginTop: 'auto' }}>
                                ...
                                <span style={{ fontSize: 12, color: '#0c4d86', fontWeight: 400 }}>{l.contact_info}</span>
                              </div>
                            )}

                            <p style={{ fontSize: 10, color: 'rgba(24,24,49,0.26)', fontWeight: 400 }}>
                          ...
                          {isOwn && !isTaken && (
                            <button
                              ...
                              style={{
                                ...
                                cursor: 'pointer', fontSize: 11, fontFamily: 'inherit', fontWeight: 400,
                ...
                <div style={{ maxWidth: 560, margin: '0 auto' }}>
                  ...
                  {authStep === 'login' && (
                    <div style={{ textAlign: 'center', padding: '60px 0' }}>
                      <p style={{ fontSize: 14, color: 'rgba(24,24,49,0.75)', fontWeight: 400, marginBottom: 20 }}>Log in to post a listing</p>
                      <Link href="/login" style={{ display: 'inline-block', background: '#181831', color: 'white', padding: '11px 28px', borderRadius: 12, fontSize: 13, fontWeight: 400, textDecoration: 'none' }}>
                        Log in
                      </Link>
                    </div>
                  )}
                  {authStep === 'alias' && (
                    <div style={{ paddingTop: 8 }}>
                      <p style={{ fontSize: 14, color: '#181831', fontWeight: 400, marginBottom: 6 }}>Pick a community name first</p>
                      <p style={{ fontSize: 13, color: 'rgba(24,24,49,0.72)', fontWeight: 400, marginBottom: 18, lineHeight: 1.5 }}>
                  ...
                  {authStep === 'ready' && (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
                        ...
                        <div style={{ display: 'flex', gap: 8 }}>
                          {(['offering', 'seeking'] as const).map(t => (
                            <button key={t} onClick={() => setListingType(t)} style={{
                              flex: 1, padding: '11px', borderRadius: 12, fontSize: 13, fontWeight: 400,
                              border: '1px solid', cursor: 'pointer', fontFamily: 'inherit', transition: 'all 0.15s',
                              background: listingType === t ? '#181831' : '#f8f9fb',
                              color: listingType === t ? 'white' : 'rgba(24,24,49,0.78)',
                      ...
                      <p style={{ fontSize: 11, color: 'rgba(24,24,49,0.78)', fontWeight: 400, textAlign: 'center' }}>
...
const labelStyle: React.CSSProperties = {
  fontSize: 11, color: 'rgba(24,24,49,0.75)', fontWeight: 400,
